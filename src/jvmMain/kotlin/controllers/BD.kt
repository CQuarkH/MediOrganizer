...
const val PATIENT_PATH = "/home/c_quark/IdeaProjects/withers/Proyecto-Final/src/jvmMain/kotlin/bd/patients";
const val APPOINTMENT_PATH = "/home/c_quark/IdeaProjects/withers/Proyecto-Final/src/jvmMain/kotlin/bd/appointments"
const val NOTES_PATH = "/home/c_quark/IdeaProjects/withers/Proyecto-Final/src/jvmMain/kotlin/bd/notes"
    ...
    companion object{
            ...
            fun getPatientByRut(id: String): Patient {
                ...
                return Patient(
                    ...
                    medicalFindings = lines.drop(5).joinToString("\n").removePrefix("Medical Findings: ")
            ...
            suspend fun getPatientsList(): LinkedList<Patient> = withContext(Dispatchers.IO) {
                 ...
                 if (patientPath.exists()) {
                      ...
                      if (lines.size >= 3) {
                        ...
                        val medicalFindings = lines.drop(5).joinToString("\n").removePrefix("Medical Findings: ")

                        if (age != null) {
                            patientList.add(Patient(name = name, surname = surname, age = age, RUT = rut, date = date, medicalFindings = medicalFindings))
                        }
                    }
                }
            }
            ...
            suspend fun getAppointmentsList(): LinkedList<Appointment> = withContext(Dispatchers.IO){
                ...
                if (appointmentPath.exists()) {
                    appointmentPath.listFiles()?.forEach {
                        ...
                        appointmentsList.add(Appointment(time = time, date = date, getPatientByRut(rut)))
                    }
                }
            ...
            suspend fun getNotesList(): LinkedList<Note> = withContext(Dispatchers.IO){
                val notesList = LinkedList<Note>()
                val notesPath = File(NOTES_PATH)

                if (notesPath.exists()) {
                    notesPath.listFiles()?.forEach {
                            note ->
